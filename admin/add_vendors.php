...
{
    if(empty($_POST['uname']) ||  empty($_POST['fname']) || empty($_POST['password']) || empty($_POST['phone']))
    {
	...
	{
        $check_username= mysqli_query($db, "SELECT username FROM vendors where username = '".$_POST['uname']."' ");
        ...
        elseif(mysqli_num_rows($check_username) > 0)
        {
            ...
            $mql = "INSERT INTO vendors(hut_id,name,number,username,password) VALUES('".$_POST['res_name']."','".$_POST['fname']."','".$_POST['phone']."','".$_POST['uname']."','".md5($_POST['password'])."')";
            mysqli_query($db, $mql);
...
<head>
    ...
    <title>Add Vendors | Food Ordering System</title>
    <!-- Bootstrap Core CSS -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i
                                    ...
                                    class="hide-menu">Huts</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="allrestraunt.php">View Huts</a></li>
                                <li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_restraunt.php">Add Huts</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery"
                                    aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="all_menu.php">View Menu</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Add Vendors</h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="res_name" class="form-control custom-select" data-placeholder="Choose a Hut" tabindex="1">
