...
<head>
    ...
    <title>Add Huts | Food Ordering System</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">Add Huts</h4>
                        </div>
                        <div class="card-body">
                            <form action='' method='post' enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Hut Name</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                <label class="control-label">Hut E-mail</label>
                                    ...
                                    <!--/row-->
                                    <h3 class="box-title m-t-40">Hut Address</h3>
                                    <hr>
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <div class="form-group">
