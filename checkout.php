...
{  
	foreach ($_SESSION["cart_item"] as $item)
	{
		...
		if($_POST['submit'])
		{
			$SQL="insert into users_orders(u_id,h_id,m_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["hutId"]."','".$item["d_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."')";
			mysqli_query($db,$SQL);
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-color"><strong>
                                                                    <?php echo "Rs. ".$item_total; ?></strong></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <li>
                                                    <label class="custom-control custom-radio  m-b-20">
                                                        <input name="mod" id="radioStacked1" checked value="COD"
                                                            ...
                                                            delivery</span>
                                                        <br> <span>Please send your cheque to Hut Name, Hut Street,
                                                            Hut Town, Hut State / County, Hut Postcode.</span>
                                                    </label>
                                                </li>
                                                <li>
