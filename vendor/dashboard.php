...
<head>
    ...
    <title>Vendor Dashboard | Food Ordering System</title>
    <!-- Bootstrap Core CSS -->
                        ...
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $id=$_SESSION['hut_id']; $sql="select * from dishes where rs_id=$id";
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $id=$_SESSION['hut_id']; $sql="select * from users_orders where h_id = $id";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													echo $rws;?></h2>
